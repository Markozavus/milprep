...
def home():
    reviews = [
        {
            "name": "נועם, 19, תל אביב",
            "unit": "8200",
            "text": "האתר עזר לי להבין איזה כישורים אני צריכ/ה לפתח בשביל מודיעין ולמצוא קורסים מתאימים."
        },
        {
            "name": "דניאל, 18, חיפה",
            "unit": "סיירת גולני",
            "text": "לא ידעתי בכלל לאיזה יחידה לכוון. המערכת המליצה לי על מסלול שמתאים ליכולות הפיזיות שלי."
        },
        {
            "name": "מיה, 20, ראשון לציון",
            "unit": "חיל האוויר",
            "text": "קיבלתי מידע מדויק על דרישות הרפואיות ועל קורסים מקדימים. חסך לי המון בלגן."
        },
        {
            "name": "אלכס, 19, ירושלים",
            "unit": "מודיעין שדה",
            "text": "הביקורות של החיילים לשעבר על היחידות היו הכי שימושיות בשבילי."
        },
    ]
